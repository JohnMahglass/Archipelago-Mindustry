...
item_table = {
    ...
    "Cryofluid Mixer": ItemData(MINDUSTRY_BASE_ID + 58, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.INDUSTRY),
...
"""
Notes:
- "Filler items" should be created to balance the number of item/location when submitting them to the generation process.
