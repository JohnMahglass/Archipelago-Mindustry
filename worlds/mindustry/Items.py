...
item_table = {
    ...
    "Progressive Drills Serpulo": ItemData(MINDUSTRY_BASE_ID + 169, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.EXTRACTION, 3),
    "Progressive Generators Serpulo": ItemData(MINDUSTRY_BASE_ID + 170, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.ENERGY, 7),
