...
item_table = {
    ...
    #"Reinforced Container": ItemData(MINDUSTRY_BASE_ID + 210, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
    #"Reinforced Vault": ItemData(MINDUSTRY_BASE_ID + 211, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
    #"Reinforced Message": ItemData(MINDUSTRY_BASE_ID + 212, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.LOGIC, 1),
    #"Canvas": ItemData(MINDUSTRY_BASE_ID + 213, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.LOGIC, 1),
#
    #"Reinforced Payload Conveyor": ItemData(MINDUSTRY_BASE_ID + 214, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.BELT, 1),
    #"Payload Mass Driver": ItemData(MINDUSTRY_BASE_ID + 215, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.BELT, 1),
    #"Payload Loader": ItemData(MINDUSTRY_BASE_ID + 216, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.BELT, 1),
    #"Payload Unloader": ItemData(MINDUSTRY_BASE_ID + 217, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.BELT, 1),
    #"Large Payload Mass Driver": ItemData(MINDUSTRY_BASE_ID + 218, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.BELT, 1),
    #"Constructor": ItemData(MINDUSTRY_BASE_ID + 219, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Deconstructor": ItemData(MINDUSTRY_BASE_ID + 220, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Large Constructor": ItemData(MINDUSTRY_BASE_ID + 221, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Large Deconstructor": ItemData(MINDUSTRY_BASE_ID + 222, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Reinforced Payload Router": ItemData(MINDUSTRY_BASE_ID + 223, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
#
    #"Plasma Bore": ItemData(MINDUSTRY_BASE_ID + 224, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.EXTRACTION, 1),
    #"Impact Drill": ItemData(MINDUSTRY_BASE_ID + 225, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.EXTRACTION, 1),
    #"Large Plasma Bore": ItemData(MINDUSTRY_BASE_ID + 226, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.EXTRACTION, 1),
    #"Eruption Drill": ItemData(MINDUSTRY_BASE_ID + 227, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.EXTRACTION, 1),
#
    #"Turbine Condenser": ItemData(MINDUSTRY_BASE_ID + 228, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Beam Node": ItemData(MINDUSTRY_BASE_ID + 229, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Vent Condenser": ItemData(MINDUSTRY_BASE_ID + 230, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Chemical Combustion Chamber": ItemData(MINDUSTRY_BASE_ID + 231, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Pyrolysis Generator": ItemData(MINDUSTRY_BASE_ID + 232, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Flux Reactor": ItemData(MINDUSTRY_BASE_ID + 233, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Neoplasia Reactor": ItemData(MINDUSTRY_BASE_ID + 234, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Beam Tower": ItemData(MINDUSTRY_BASE_ID + 235, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.ENERGY, 1),
    #"Regen Projector": ItemData(MINDUSTRY_BASE_ID + 236, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
    #"Build Tower": ItemData(MINDUSTRY_BASE_ID + 237, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
    #"Shockwave Tower": ItemData(MINDUSTRY_BASE_ID + 238, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
    #"Reinforced Conduit": ItemData(MINDUSTRY_BASE_ID + 239, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    #"Reinforced Pump": ItemData(MINDUSTRY_BASE_ID + 240, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.EXTRACTION, 1),
    #"Reinforced Liquid Junction": ItemData(MINDUSTRY_BASE_ID + 241, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    #"Reinforced Bridge Conduit": ItemData(MINDUSTRY_BASE_ID + 242, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    #"Reinforced Liquid Router": ItemData(MINDUSTRY_BASE_ID + 243, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    #"Reinforced Liquid Container": ItemData(MINDUSTRY_BASE_ID + 244, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    #"Reinforced Liquid Tank": ItemData(MINDUSTRY_BASE_ID + 245, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    ##"Cliff Crusher": ItemData(MINDUSTRY_BASE_ID + 246, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.EXTRACTION, 1),
    ##"Silicon Arc Furnace": ItemData(MINDUSTRY_BASE_ID + 247, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Electrolyzer": ItemData(MINDUSTRY_BASE_ID + 248, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Oxidation Chamber": ItemData(MINDUSTRY_BASE_ID + 249, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Surge Crucible": ItemData(MINDUSTRY_BASE_ID + 250, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Heat Redirector": ItemData(MINDUSTRY_BASE_ID + 251, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Electric Heater": ItemData(MINDUSTRY_BASE_ID + 252, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Slag Heater": ItemData(MINDUSTRY_BASE_ID + 253, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Atmospheric Concentrator": ItemData(MINDUSTRY_BASE_ID + 254, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Cyanogen Synthesizer": ItemData(MINDUSTRY_BASE_ID + 255, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Carbide Crucible": ItemData(MINDUSTRY_BASE_ID + 256, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Phase Synthesizer": ItemData(MINDUSTRY_BASE_ID + 257, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Phase Heater": ItemData(MINDUSTRY_BASE_ID + 258, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Heat Router": ItemData(MINDUSTRY_BASE_ID + 259, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
    #"Slag Incinerator": ItemData(MINDUSTRY_BASE_ID + 260, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.INDUSTRY, 1),
#
    ##"Breach": ItemData(MINDUSTRY_BASE_ID + 261, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    ##"Beryllium Wall": ItemData(MINDUSTRY_BASE_ID + 262, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Large Beryllium Wall": ItemData(MINDUSTRY_BASE_ID + 263, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Tungsten Wall": ItemData(MINDUSTRY_BASE_ID + 264, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Large Tungsten Wall": ItemData(MINDUSTRY_BASE_ID + 265, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Blast Door": ItemData(MINDUSTRY_BASE_ID + 266, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Reinforced Surge Wall": ItemData(MINDUSTRY_BASE_ID + 267, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Large Reinforced Surge Wall": ItemData(MINDUSTRY_BASE_ID + 268, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Shielded Wall": ItemData(MINDUSTRY_BASE_ID + 269, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Carbide Wall": ItemData(MINDUSTRY_BASE_ID + 270, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Large Carbide Wall": ItemData(MINDUSTRY_BASE_ID + 271, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    #"Diffuse": ItemData(MINDUSTRY_BASE_ID + 272, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Sublimate": ItemData(MINDUSTRY_BASE_ID + 273, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Afflict": ItemData(MINDUSTRY_BASE_ID + 274, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Titan": ItemData(MINDUSTRY_BASE_ID + 275, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Lustre": ItemData(MINDUSTRY_BASE_ID + 276, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Smite": ItemData(MINDUSTRY_BASE_ID + 277, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Disperse": ItemData(MINDUSTRY_BASE_ID + 278, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Scathe": ItemData(MINDUSTRY_BASE_ID + 279, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Malign": ItemData(MINDUSTRY_BASE_ID + 280, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
    #"Radar": ItemData(MINDUSTRY_BASE_ID + 281, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.TURRET, 1),
#
    #"Core: Citadel": ItemData(MINDUSTRY_BASE_ID + 282, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
    #"Core: Acropolis": ItemData(MINDUSTRY_BASE_ID + 283, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.MISC, 1),
#
    ##"Tank Fabricator": ItemData(MINDUSTRY_BASE_ID + 284, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    ##"Stell": ItemData(MINDUSTRY_BASE_ID + 285, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Unit Repair Tower": ItemData(MINDUSTRY_BASE_ID + 286, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Ship Fabricator": ItemData(MINDUSTRY_BASE_ID + 287, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Elude": ItemData(MINDUSTRY_BASE_ID + 288, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Mech Fabricator": ItemData(MINDUSTRY_BASE_ID + 289, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Merui": ItemData(MINDUSTRY_BASE_ID + 290, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Tank Refabricator": ItemData(MINDUSTRY_BASE_ID + 291, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Locus": ItemData(MINDUSTRY_BASE_ID + 292, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Mech Refrabricator": ItemData(MINDUSTRY_BASE_ID + 293, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Cleroi": ItemData(MINDUSTRY_BASE_ID + 294, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Ship Refabricator": ItemData(MINDUSTRY_BASE_ID + 295, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Avert": ItemData(MINDUSTRY_BASE_ID + 296, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Prime Refabricator": ItemData(MINDUSTRY_BASE_ID + 297, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Precept": ItemData(MINDUSTRY_BASE_ID + 298, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Anthicus": ItemData(MINDUSTRY_BASE_ID + 299, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Obviate": ItemData(MINDUSTRY_BASE_ID + 300, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Tank Assembler": ItemData(MINDUSTRY_BASE_ID + 301, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Vanquish": ItemData(MINDUSTRY_BASE_ID + 302, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Conquer": ItemData(MINDUSTRY_BASE_ID + 303, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Ship Assembler": ItemData(MINDUSTRY_BASE_ID + 304, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Quell": ItemData(MINDUSTRY_BASE_ID + 305, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Disrupt": ItemData(MINDUSTRY_BASE_ID + 306, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Mech Assembler": ItemData(MINDUSTRY_BASE_ID + 307, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.FACTORY, 1),
    #"Tecta": ItemData(MINDUSTRY_BASE_ID + 308, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Collaris": ItemData(MINDUSTRY_BASE_ID + 309, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
    #"Basic Assembler Module": ItemData(MINDUSTRY_BASE_ID + 310, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.UNIT, 1),
#
    #"Aegis": ItemData(MINDUSTRY_BASE_ID + 311, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Lake": ItemData(MINDUSTRY_BASE_ID + 312, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Intersect": ItemData(MINDUSTRY_BASE_ID + 313, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Atlas": ItemData(MINDUSTRY_BASE_ID + 314, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Split": ItemData(MINDUSTRY_BASE_ID + 315, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Basin": ItemData(MINDUSTRY_BASE_ID + 316, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Marsh": ItemData(MINDUSTRY_BASE_ID + 317, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Ravine": ItemData(MINDUSTRY_BASE_ID + 318, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Caldera": ItemData(MINDUSTRY_BASE_ID + 319, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Stronghold": ItemData(MINDUSTRY_BASE_ID + 320, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Crevice": ItemData(MINDUSTRY_BASE_ID + 321, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Siege": ItemData(MINDUSTRY_BASE_ID + 322, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Crossroads": ItemData(MINDUSTRY_BASE_ID + 323, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Krast": ItemData(MINDUSTRY_BASE_ID + 324, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Origin": ItemData(MINDUSTRY_BASE_ID + 325, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
    #"Peaks": ItemData(MINDUSTRY_BASE_ID + 326, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.SECTOR, 1),
#
    #"Oxide": ItemData(MINDUSTRY_BASE_ID + 327, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Ozone": ItemData(MINDUSTRY_BASE_ID + 328, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Hydrogen": ItemData(MINDUSTRY_BASE_ID + 329, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Nitrogen": ItemData(MINDUSTRY_BASE_ID + 330, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Cyanogen": ItemData(MINDUSTRY_BASE_ID + 331, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Neoplasm": ItemData(MINDUSTRY_BASE_ID + 332, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Tungsten": ItemData(MINDUSTRY_BASE_ID + 333, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Slag": ItemData(MINDUSTRY_BASE_ID + 334, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Arkycite": ItemData(MINDUSTRY_BASE_ID + 335, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
    #"Carbide": ItemData(MINDUSTRY_BASE_ID + 336, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.RESSOURCES, 1),
