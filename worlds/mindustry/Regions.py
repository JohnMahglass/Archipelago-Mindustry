...
class MindustryRegions():
    ...
    def __create_serpulo_campaign(self, options: MindustryOptions):
        ...
        self.node_copper = self.__add_region("Copper Serpulo", MindustryLocations.serpulo_copper)
        self.node_water_serpulo = self.__add_region("Water Serpulo", MindustryLocations.serpulo_water)
        self.node_sand_serpulo = self.__add_region("Sand Serpulo", MindustryLocations.serpulo_sand)
        self.node_lead = self.__add_region("Lead Serpulo", MindustryLocations.serpulo_lead)
        self.node_titanium = self.__add_region("Titanium Serpulo", MindustryLocations.serpulo_titanium)
        self.node_cryofluid = self.__add_region("Cryofluid Serpulo", MindustryLocations.serpulo_cryofluid)
        self.node_thorium_serpulo = self.__add_region("Thorium Serpulo", MindustryLocations.serpulo_thorium)
        self.node_surge_alloy_serpulo = self.__add_region("Surge Alloy Serpulo", MindustryLocations.serpulo_surge_alloy)
        self.node_phase_fabric_serpulo = self.__add_region("Phase Fabric Serpulo", MindustryLocations.serpulo_phase_fabric)
        self.node_metaglass = self.__add_region("Metaglass Serpulo", MindustryLocations.serpulo_metaglass)
        self.node_scrap = self.__add_region("Scrap Serpulo", MindustryLocations.serpulo_scrap)
        self.node_slag_serpulo = self.__add_region("Slag Serpulo", MindustryLocations.serpulo_slag)
        self.node_coal = self.__add_region("Coal Serpulo", MindustryLocations.serpulo_coal)
        self.node_graphite_serpulo = self.__add_region("Graphite Serpulo", MindustryLocations.serpulo_graphite)
        self.node_silicon_serpulo = self.__add_region("Silicon Serpulo", MindustryLocations.serpulo_silicon)
        self.node_pyratite = self.__add_region("Pyratite Serpulo", MindustryLocations.serpulo_pyratite)
        self.node_blast_compound = self.__add_region("Blast Compound Serpulo", MindustryLocations.serpulo_blast_compound)
        self.node_spore_pod = self.__add_region("Spore Pod Serpulo", MindustryLocations.serpulo_spore_pod)
        self.node_oil = self.__add_region("Oil Serpulo", MindustryLocations.serpulo_oil)
        self.node_plastanium = self.__add_region("Plastanium Serpulo", MindustryLocations.serpulo_plastanium)
    ...
    def __create_erekir_campaign(self, options: MindustryOptions):
        ...
        self.node_split = self.__add_region("Split", MindustryLocations.erekir_split)
        self.node_basin = self.__add_region("Basin", MindustryLocations.erekir_basin)
        self.node_marsh = self.__add_region("Marsh", MindustryLocations.erekir_marsh)
        self.node_ravine = self.__add_region("Ravine", MindustryLocations.erekir_ravine)
        self.node_caldera = self.__add_region("Caldera", MindustryLocations.erekir_caldera)
        self.node_stronghold = self.__add_region("Stronghold", MindustryLocations.erekir_stronghold)
        self.node_crevice = self.__add_region("Crevice", MindustryLocations.erekir_crevice)
        self.node_siege = self.__add_region("Siege", MindustryLocations.erekir_siege)
        self.node_crossroads = self.__add_region("Crossroads", MindustryLocations.erekir_crossroads)
        self.node_karst = self.__add_region("Karst", MindustryLocations.erekir_karst)
        self.node_origin = self.__add_region("Origin", MindustryLocations.erekir_origin)
        self.node_peaks = self.__add_region("Peaks", MindustryLocations.erekir_peaks)

        self.node_beryllium = self.__add_region("Beryllium", MindustryLocations.erekir_beryllium)
        self.node_sand_erekir = self.__add_region("Sand Erekir", MindustryLocations.erekir_sand)
        self.node_silicon_erekir = self.__add_region("Silicon Erekir", MindustryLocations.erekir_silicon)
        self.node_oxide = self.__add_region("Oxide", MindustryLocations.erekir_oxide)
        self.node_water_erekir = self.__add_region("Water Erekir", MindustryLocations.erekir_water)
        self.node_ozone = self.__add_region("Ozone", MindustryLocations.erekir_ozone)
        self.node_hydrogen = self.__add_region("Hydrogen", MindustryLocations.erekir_hydrogen)
        self.node_nitrogen = self.__add_region("Nitrogen", MindustryLocations.erekir_nitrogen)
        self.node_cyanogen = self.__add_region("Cyanogen", MindustryLocations.erekir_cyanogen)
        self.node_neoplasm = self.__add_region("Neoplasm", MindustryLocations.erekir_neoplasm)
        self.node_graphite_erekir = self.__add_region("Graphite Erekir", MindustryLocations.erekir_graphite)
        self.node_tungsten = self.__add_region("Tungsten", MindustryLocations.erekir_tungsten)
        self.node_slag_erekir = self.__add_region("Slag Erekir", MindustryLocations.erekir_slag)
        self.node_arkycite = self.__add_region("Arkycite", MindustryLocations.erekir_arkycite)
        self.node_thorium_erekir = self.__add_region("Thorium Erekir", MindustryLocations.erekir_thorium)
        self.node_carbide = self.__add_region("Carbide", MindustryLocations.erekir_carbide)
        self.node_surge_alloy_erekir = self.__add_region("Surge Alloy Erekir", MindustryLocations.erekir_surge_alloy)
        self.node_phase_fabric_erekir = self.__add_region("Phase Fabric Erekir", MindustryLocations.erekir_phase_fabric)
