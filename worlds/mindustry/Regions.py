...
class MindustryRegions:
    ...
    def __create_serpulo_campaign(self):
        ...
        self.node_frozen_forest = self.__add_region("Frozen Forest", MindustryLocation.tech_tree_serpulo.get("Node Frozen Forest"))
        self.node_the_craters = self.__add_region("The Craters", MindustryLocation.tech_tree_serpulo.get("Node the Craters"))
        self.node_ruinous_shores = self.__add_region("Ruinous Shores", MindustryLocation.tech_tree_serpulo.get("Node Ruinous Shores"))
        self.node_windswept_islands = self.__add_region("Windswept Islands", MindustryLocation.tech_tree_serpulo.get("Node Windswept Islands"))
        self.node_tar_fields = self.__add_region("Tar Fields", MindustryLocation.tech_tree_serpulo.get("Node Tar Fields"))
        self.node_impact_0078 = self.__add_region("Impact 0078", MindustryLocation.tech_tree_serpulo.get("Node Impact 0078"))
        self.node_desolate_rift = self.__add_region("Desolate Rift", MindustryLocation.tech_tree_serpulo.get("Node Desolate Rift"))
        self.node_planetary_launch_terminal = self.__add_region("Planetary Launch Terminal", MindustryLocation.tech_tree_serpulo.get("Node Planetary Launch Terminal"))
        self.node_extraction_outpost = self.__add_region("Extraction Outpost", MindustryLocation.tech_tree_serpulo.get("Node Extraction Outpost"))
        self.node_salt_flats = self.__add_region("Salt Flats", MindustryLocation.tech_tree_serpulo.get("Node Salt Flats"))
        self.node_coastline = self.__add_region("Coastline", MindustryLocation.tech_tree_serpulo.get("Node Coastline"))
        self.node_naval_fortress = self.__add_region("Naval Fortress", MindustryLocation.tech_tree_serpulo.get("Node Naval Fortress"))
        self.node_overgrowth = self.__add_region("Overgrowth", MindustryLocation.tech_tree_serpulo.get("Node Overgrowth"))
        self.node_biomass_synthesis_facility = self.__add_region("Biomass Synthesis Facility", MindustryLocation.tech_tree_serpulo.get("Node Biomass Synthesis Facility"))
        self.node_stained_mountains = self.__add_region("Stained Mountains", MindustryLocation.tech_tree_serpulo.get("Node Stained Mountains"))
        self.node_fungal_pass = self.__add_region("Fungal Pass", MindustryLocation.tech_tree_serpulo.get("Node Fungal Pass"))
        self.node_nuclear_production_complex = self.__add_region("Nuclear Production Complex", MindustryLocation.tech_tree_serpulo.get("Node Nuclear Production Complex"))
        self.node_lead = self.__add_region("Lead", MindustryLocation.tech_tree_serpulo.get("Node Lead"))
        self.node_titanium = self.__add_region("Titanium", MindustryLocation.tech_tree_serpulo.get("Node Titanium"))
        self.node_cryofluid = self.__add_region("Cryofluid", MindustryLocation.tech_tree_serpulo.get("Node Cryofluid"))
        self.node_thorium = self.__add_region("Thorium", MindustryLocation.tech_tree_serpulo.get("Node Thorium"))
        self.node_surge_alloy = self.__add_region("Surge Alloy", MindustryLocation.tech_tree_serpulo.get("Node Surge Alloy"))
        self.node_phase_fabric = self.__add_region("Phase Fabric", MindustryLocation.tech_tree_serpulo.get("Node Phase Fabric"))
        self.node_metaglass = self.__add_region("Metaglass", MindustryLocation.tech_tree_serpulo.get("Node Metaglass"))
        self.node_scrap = self.__add_region("Scrap", MindustryLocation.tech_tree_serpulo.get("Node Scrap"))
        self.node_slag = self.__add_region("Slag", MindustryLocation.tech_tree_serpulo.get("Node Slag"))
        self.node_coal = self.__add_region("Coal", MindustryLocation.tech_tree_serpulo.get("Node Coal"))
        self.node_graphite = self.__add_region("Graphite", MindustryLocation.tech_tree_serpulo.get("Node Graphite"))
        self.node_silicon = self.__add_region("Silicon", MindustryLocation.tech_tree_serpulo.get("Node Silicon"))
        self.node_pyratite = self.__add_region("Pyratite", MindustryLocation.tech_tree_serpulo.get("Node Pyratite"))
        self.node_blast_compound = self.__add_region("Blast Compound", MindustryLocation.tech_tree_serpulo.get("Node Blast Compound"))
        self.node_spore_pod = self.__add_region("Spore Pod", MindustryLocation.tech_tree_serpulo.get("Node Spore Pod"))
        self.node_oil = self.__add_region("Oil", MindustryLocation.tech_tree_serpulo.get("Node Oil"))
        self.node_plastanium = self.__add_region("Plastanium", MindustryLocation.tech_tree_serpulo.get("Node Plastanium"))
