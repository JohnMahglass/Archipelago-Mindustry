...
item_table = {
    ...
    "Mender": ItemData(MINDUSTRY_BASE_ID + 76, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.MISC),
    ...
    "Air Factory": ItemData(MINDUSTRY_BASE_ID + 140, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.FACTORY),
    "Flare": ItemData(MINDUSTRY_BASE_ID + 141, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.UNIT),
    ...
    "Naval Factory": ItemData(MINDUSTRY_BASE_ID + 151, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.FACTORY),
    "Risso": ItemData(MINDUSTRY_BASE_ID + 152, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.UNIT),
    ...
    "Scrap": ItemData(MINDUSTRY_BASE_ID + 169, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Coal": ItemData(MINDUSTRY_BASE_ID + 170, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Cryofluid": ItemData(MINDUSTRY_BASE_ID + 171, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Thorium": ItemData(MINDUSTRY_BASE_ID + 172, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Surge Alloy": ItemData(MINDUSTRY_BASE_ID + 173, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Phase Fabric": ItemData(MINDUSTRY_BASE_ID + 174, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Silicon": ItemData(MINDUSTRY_BASE_ID + 175, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Blast Compound": ItemData(MINDUSTRY_BASE_ID + 176, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Plastanium": ItemData(MINDUSTRY_BASE_ID + 177, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    ...
    "Ruinous Shores": ItemData(MINDUSTRY_BASE_ID + 181, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Windswept Islands": ItemData(MINDUSTRY_BASE_ID + 182, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Tar Fields": ItemData(MINDUSTRY_BASE_ID + 183, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Impact 0078": ItemData(MINDUSTRY_BASE_ID + 184, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Desolate Rift": ItemData(MINDUSTRY_BASE_ID + 185, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Planetary Launch Terminal": ItemData(MINDUSTRY_BASE_ID + 186, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Extraction Outpost": ItemData(MINDUSTRY_BASE_ID + 187, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Salt Flats": ItemData(MINDUSTRY_BASE_ID + 188, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Coastline": ItemData(MINDUSTRY_BASE_ID + 189, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Naval Fortress": ItemData(MINDUSTRY_BASE_ID + 190, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Overgrowth": ItemData(MINDUSTRY_BASE_ID + 191, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Stained Mountains": ItemData(MINDUSTRY_BASE_ID + 192, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Fungal Pass": ItemData(MINDUSTRY_BASE_ID + 193, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Nuclear Production Complex": ItemData(MINDUSTRY_BASE_ID + 194, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.SECTOR),
    "Slag": ItemData(MINDUSTRY_BASE_ID + 195, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Graphite": ItemData(MINDUSTRY_BASE_ID + 196, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Pyratite": ItemData(MINDUSTRY_BASE_ID + 197, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Spore Pod": ItemData(MINDUSTRY_BASE_ID + 198, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Oil": ItemData(MINDUSTRY_BASE_ID + 199, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES)
}
"""
Notes:
