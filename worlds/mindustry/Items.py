...
item_table = {
    ...
    "Junction": ItemData(MINDUSTRY_BASE_ID + 1, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.BELT, 1),
    "Router": ItemData(MINDUSTRY_BASE_ID + 2, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.BELT, 1),
    ...
    "Bridge Conveyor": ItemData(MINDUSTRY_BASE_ID + 12, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.BELT, 1),
    ...
    "Liquid Junction": ItemData(MINDUSTRY_BASE_ID + 25, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.CONDUIT, 1),
    "Liquid Router": ItemData(MINDUSTRY_BASE_ID + 26, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.CONDUIT, 1),
    ...
    "Bridge Conduit": ItemData(MINDUSTRY_BASE_ID + 29, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.CONDUIT, 1),
    ...
    "Hail": ItemData(MINDUSTRY_BASE_ID + 107, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Salvo": ItemData(MINDUSTRY_BASE_ID + 108, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Swarmer": ItemData(MINDUSTRY_BASE_ID + 109, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Cyclone": ItemData(MINDUSTRY_BASE_ID + 110, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Spectre": ItemData(MINDUSTRY_BASE_ID + 111, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Ripple": ItemData(MINDUSTRY_BASE_ID + 112, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Fuse": ItemData(MINDUSTRY_BASE_ID + 113, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Scorch": ItemData(MINDUSTRY_BASE_ID + 114, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Arc": ItemData(MINDUSTRY_BASE_ID + 115, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Wave": ItemData(MINDUSTRY_BASE_ID + 116, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.TURRET, 1),
    "Parallax": ItemData(MINDUSTRY_BASE_ID + 117, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Segment": ItemData(MINDUSTRY_BASE_ID + 118, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Tsunami": ItemData(MINDUSTRY_BASE_ID + 119, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Lancer": ItemData(MINDUSTRY_BASE_ID + 120, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Meltdown": ItemData(MINDUSTRY_BASE_ID + 121, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Foreshadow": ItemData(MINDUSTRY_BASE_ID + 122, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Shock Mine": ItemData(MINDUSTRY_BASE_ID + 123, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.MISC, 1),
    ...
    "Duct Router": ItemData(MINDUSTRY_BASE_ID + 201, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.BELT, 1),
    "Duct Bridge": ItemData(MINDUSTRY_BASE_ID + 202, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.BELT, 1),
    ...
    "Constructor": ItemData(MINDUSTRY_BASE_ID + 220, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.FACTORY, 1),
    ...
    "Regen Projector": ItemData(MINDUSTRY_BASE_ID + 237, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.MISC, 1),
    "Build Tower": ItemData(MINDUSTRY_BASE_ID + 238, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.MISC, 1),
    "Shockwave Tower": ItemData(MINDUSTRY_BASE_ID + 239, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.MISC, 1),
    ...
    "Reinforced Liquid Junction": ItemData(MINDUSTRY_BASE_ID + 242, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.CONDUIT, 1),
    "Reinforced Bridge Conduit": ItemData(MINDUSTRY_BASE_ID + 243, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.CONDUIT, 1),
    "Reinforced Liquid Router": ItemData(MINDUSTRY_BASE_ID + 244, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.CONDUIT, 1),
    ...
    "Tungsten Wall": ItemData(MINDUSTRY_BASE_ID + 265, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Large Tungsten Wall": ItemData(MINDUSTRY_BASE_ID + 266, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Blast Door": ItemData(MINDUSTRY_BASE_ID + 267, ItemPlanet.EREKIR, ItemType.USEFUL, ItemGroup.WALL, 1),
    "Reinforced Surge Wall": ItemData(MINDUSTRY_BASE_ID + 268, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Large Reinforced Surge Wall": ItemData(MINDUSTRY_BASE_ID + 269, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Shielded Wall": ItemData(MINDUSTRY_BASE_ID + 270, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Carbide Wall": ItemData(MINDUSTRY_BASE_ID + 271, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Large Carbide Wall": ItemData(MINDUSTRY_BASE_ID + 272, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.WALL, 1),
    "Diffuse": ItemData(MINDUSTRY_BASE_ID + 273, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Sublimate": ItemData(MINDUSTRY_BASE_ID + 274, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Afflict": ItemData(MINDUSTRY_BASE_ID + 275, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Titan": ItemData(MINDUSTRY_BASE_ID + 276, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Lustre": ItemData(MINDUSTRY_BASE_ID + 277, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Smite": ItemData(MINDUSTRY_BASE_ID + 278, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Disperse": ItemData(MINDUSTRY_BASE_ID + 279, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Scathe": ItemData(MINDUSTRY_BASE_ID + 280, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    "Malign": ItemData(MINDUSTRY_BASE_ID + 281, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.TURRET, 1),
    ...
    "Prime Refabricator": ItemData(MINDUSTRY_BASE_ID + 298, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.FACTORY, 1),
    ...
    "Tank Assembler": ItemData(MINDUSTRY_BASE_ID + 302, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.FACTORY, 1),
    ...
    "Ship Assembler": ItemData(MINDUSTRY_BASE_ID + 305, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.FACTORY, 1),
    ...
    "Mech Assembler": ItemData(MINDUSTRY_BASE_ID + 308, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.FACTORY, 1),
    ...
    "Basic Assembler Module": ItemData(MINDUSTRY_BASE_ID + 311, ItemPlanet.EREKIR, ItemType.NECESSARY, ItemGroup.UNIT, 1),
