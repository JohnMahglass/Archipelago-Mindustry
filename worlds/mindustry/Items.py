...
item_table = {
    ...
    "Scrap": ItemData(MINDUSTRY_BASE_ID + 190, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
    "Slag": ItemData(MINDUSTRY_BASE_ID + 191, ItemPlanet.SERPULO, ItemType.NECESSARY, ItemGroup.RESSOURCES),
