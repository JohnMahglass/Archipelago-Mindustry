...
item_table = {
    ...
    "Mechanical Pump": ItemData(MINDUSTRY_BASE_ID + 23, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.CONDUIT),
    "Conduit": ItemData(MINDUSTRY_BASE_ID + 24, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.CONDUIT),
    ...
    "Pyratite Mixer": ItemData(MINDUSTRY_BASE_ID + 42, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.INDUSTRY),
    ...
    "Kiln": ItemData(MINDUSTRY_BASE_ID + 51, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.INDUSTRY),
    ...
    "Titanium": ItemData(MINDUSTRY_BASE_ID + 167, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.RESSOURCES),
    "Metaglass": ItemData(MINDUSTRY_BASE_ID + 168, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.RESSOURCES),
    ...
    "The Craters": ItemData(MINDUSTRY_BASE_ID + 179, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.SECTOR),
    "Biomass Synthesis Facility": ItemData(MINDUSTRY_BASE_ID + 180, ItemPlanet.SERPULO, ItemType.USEFUL, ItemGroup.SECTOR),
