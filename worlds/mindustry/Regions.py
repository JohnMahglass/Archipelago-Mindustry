...
def _has_tar_field(state:CollectionState, player: int) -> bool:
    """If the player has target in state"""
    return state.has("Tar Fields", player)
...
class MindustryRegions:
    ...
    def __create_serpulo_campaign(self):
        ...
        self.node_conveyor = self.__add_region("Conveyor", MindustryLocations.serpulo_conveyor)
        ...
        self.node_mechanical_drill = self.__add_region("Mechanical Drill", MindustryLocations.serpulo_mechanical_drill)
        ...
        self.node_duo = self.__add_region("Duo", MindustryLocations.serpulo_duo)
        self.node_copper_wall = self.__add_region("Copper Wall", MindustryLocations.serpulo_copper_wall)
        ...
        self.node_scatter = self.__add_region("Scatter", MindustryLocations.serpulo_scatter)
