...
def _has_thorium_serpulo(state: CollectionState, player: int) -> bool:
    ...
    available: bool = False
    if state.has("Thorium produced on Serpulo", player) and _has_power_serpulo(state, player) and _has_laser_drill(state, player):
        available = True
    return available
